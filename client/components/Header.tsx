...
export default function Header({ hideOnLoad = false }: HeaderProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Show header after scrolling past hero section (e.g., 800px)
      if (hideOnLoad) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span
              className={`text-2xl font-black transition-all duration-300 ${
                isScrolled
                  ? "text-white drop-shadow-lg bg-gradient-to-r from-wine via-disrupting-pink to-burgundy bg-clip-text text-transparent"
                  : "text-wine"
              }`}
            >
              Disrupting Labs
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              ...
              className={`transition-all duration-300 ${
                isScrolled
                  ...
                  : "text-disrupting-gray hover:text-disrupting-dark"
              }`}
            >
              Services
            </Link>
            ...
            <Button
              onClick={openModal}
              className="bg-gradient-to-r from-wine to-burgundy hover:from-wine/90 hover:to-burgundy/90 text-white px-8 py-3 rounded-xl font-bold text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              Get Started
            </Button>
          </nav>
          ...
          >
            <nav className="flex flex-col space-y-3">
              <Link
                ...
                className={`transition-all duration-300 px-4 py-3 text-lg font-semibold rounded-lg ${
                  isScrolled
                    ...
                    : "text-disrupting-gray hover:text-disrupting-dark hover:bg-disrupting-gray/10"
                }`}
              ...
              <Button
                ...
                className="bg-gradient-to-r from-disrupting-purple to-disrupting-blue hover:from-disrupting-purple/90 hover:to-disrupting-blue/90 text-white w-full mt-6 rounded-xl font-bold text-xl py-4"
              >
                Get Started
              </Button>
            </nav>
